"""Single production pipeline shared by Telegram, smoke tests and manual tools."""
...
def build_research_bundle(symbol: str, target: str | Path) -> ResearchBundle:
    """Build one deterministic research bundle with all cards and machine output."""
    apply_white_theme()
    ...
    commentary_path = root / f"{ticker}_yorum.txt"
