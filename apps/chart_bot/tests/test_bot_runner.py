"""Bot dinleme zinciri yeniden başlatma testleri."""
...
class RestartSelfTests(unittest.TestCase):
    ...
    def test_workflow_token_is_preferred(self, post: Mock) -> None:
    ...
    @patch("src.bot_runner.requests.post")
    def test_failed_primary_token_falls_back(self, post: Mock) -> None:
        post.side_effect = [
